...
class ListPolicyContract:
    ...
    def __init__(self, w3: Web3, address: str):
        ...
        self.contract = w3.eth.contract(address=self.address, abi=ListPolicyMetaData.ABI)
...
def deploy_list_policy(w3: Web3, account: LocalAccount, gas_limit: int = 2000000) -> Tuple[str, str]:
    ...
    """
    contract_factory = w3.eth.contract(abi=ListPolicyMetaData.ABI, bytecode=ListPolicyMetaData.BIN)
